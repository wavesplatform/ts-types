...
export interface IExchangeTransactionOrderV1<LONG = TLong>
    extends IExchangeTransactionOrder<LONG> {
    version: 1;
}

export interface IExchangeTransactionOrderV2<LONG = TLong>
    extends IExchangeTransactionOrder<LONG> {
    version: 2;
}

export interface IExchangeTransactionOrderV3<LONG = TLong>
    extends IExchangeTransactionOrder<LONG> {
    version: 3;
    matcherFeeAssetId: string;
}

export interface IExchangeTransactionOrderV4<LONG = TLong>
    extends IExchangeTransactionOrder<LONG> {
    version: 4;
    matcherFeeAssetId: string;
}

export type TSignedIExchangeTransactionOrder<
    ORDER extends TExchangeTransactionOrder<unknown>
> = ORDER &
...
export type TExchangeTransactionOrderByTx<
    TX extends TExchangeTransaction
> = TX extends { version: 1 }
    ? TExchangeTransactionOrderMap[1]
    : TX extends { version: 2 }
    ? TExchangeTransactionOrderMap[1 | 2 | 3]
